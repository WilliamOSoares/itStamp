...
caminhoImagem = str(path.parent.absolute()) + '\\itStamp\\Teste\\test1.jpg'
caminhoEstampa = str(path.parent.absolute()) + '\\itStamp\\Estampas\\Flamengo.png'

# pegando a imagem e abrindo numa janela
imagem = cv.imread(caminhoImagem)
imagem = cv.resize(imagem, (480,720))
...
for i in range(len(contours)):
    cv.drawContours(imagem, contours, i, (150,150,150), cv.FILLED, 8)
